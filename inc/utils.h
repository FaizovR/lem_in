...
/*   Updated: 2020/09/12 10:47:30 by nalysann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ALREADY_MARKED_MSG	"ERROR: can't use ##start and ##end simultaneously"
# define NO_ROOM_S_MSG		"ERROR: no room after ##start"
# define NO_ROOM_E_MSG		"ERROR: no room after ##end"
...
# define LINK_NO_ROOM_MSG	"ERROR: links should contain only existing rooms"
# define LINK_START_MSG		"ERROR: can't use ##start when specifying links"
# define LINK_END_MSG		"ERROR: can't use ##end when specifying links"
